...
(function () {
  ...
  function pa(d, $) {
    for (var e = na(d.m()), i = 0; i < e.length; i++) {
      var a = e[i],
        o = a.g;
      if (p($, o)) {
        d.g && delete d.g[a.g];
        ...
        if (a.l) {
          a = t($, o);
          for (var g = 0; g < a.length; g++) oa(d, o, l ? a[g].clone() : a[g]);
        } else
          (a = u($, o)),
            l ? ((l = u(d, o)) ? pa(l, a) : r(d, o, a.clone())) : r(d, o, a);
      }
    }
  }
  n.prototype.clone = function () {
    var $ = new (this || d).constructor();
    $ != (this || d) && (($.h = {}), $.g && ($.g = {}), pa($, this || d));
    return $;
  };
  function p(d, $) {
    return null != d.h[$];
  ...
  function w(d, $) {
    return d.j[$].l ? (p(d, $) ? d.h[$].length : 0) : p(d, $) ? 1 : 0;
  }
  function r(d, $, e) {
    d.h[$] = e;
    d.g && (d.g[$] = e);
  ...
  function x(d, $) {
    var e,
      i = [];
    for (e in $) 0 != e && i.push(new da(e, $[e]));
    return new ma(d, i);
  }
  function y() {}
  y.prototype.g = function (d) {
    new d.h();
    throw Error("Unimplemented");
  };
  y.prototype.h = function (d, $) {
    if (11 == d.h || 10 == d.h)
      return $ instanceof n ? $ : this.g(d.s.prototype.m(), $);
    if (14 == d.h)
      return "string" === typeof $ && h.test($) && ((d = Number($)), 0 < d)
        ? d
        : $;
    if (!d.o) return $;
    d = d.s;
  ...
  A.prototype.h = function ($, e) {
    return 8 == $.h ? !!e : y.prototype.h.apply(this || d, arguments);
  };
  A.prototype.g = function ($, e) {
    return A.ma.g.call(this || d, $, e);
  };
  function B($, e) {
    null != $ && (this || d).g.apply(this || d, arguments);
  }
  B.prototype.h = "";
  B.prototype.set = function ($) {
    (this || d).h = "" + $;
  };
  B.prototype.g = function ($, e, i) {
    (this || d).h += String($);
    if (null != e)
      for (let $ = 1; $ < arguments.length; $++) (this || d).h += arguments[$];
    return this || d;
  };
  function C(d) {
    d.h = "";
    ...
    d ||
      (_ = d =
        x(H, {
          ...
          6: { name: "country_code_source", i: 14, defaultValue: 0, type: L },
  ...
  var j = {
    ...
    td = RegExp("[+＋]+"),
    nd = RegExp("^[+＋]+"),
    ed = RegExp("([0-9０-９٠-٩۰-۹])"),
    rd = RegExp("[+＋0-9０-９٠-٩۰-۹]"),
    id = /[\\\/] *x/,
    ad = RegExp("[^0-9０-９٠-٩۰-۹A-Za-z#]+$"),
    od = /(?:.*?[A-Za-z]){3}.*/,
    ud = RegExp(
  ...
  var gd = new RegExp("(?:" + Ha() + ")$", "i"),
    ...
    cd = /^\(?\$1\)?$/;
  function Ma(d) {
    return !(2 > d.length) && N(sd, d);
  }
  function Na(d) {
    return N(od, d) ? O(d, $d) : O(d, j);
  }
  function Oa(d) {
    var $ = Na(d.toString());
    C(d);
  ...
  function Pa(d) {
    return null != d && (1 != w(d, 9) || -1 != t(d, 9)[0]);
  }
  function O(d, $) {
    for (var e, i = new B(), a = d.length, o = 0; o < a; ++o)
      (e = d.charAt(o)), (e = $[e.toUpperCase()]), null != e && i.g(e);
    return i.toString();
  }
  function Qa(d) {
    return 0 == d.length || cd.test(d);
  }
  function P(d) {
  ...
  function Ra(d, $, e) {
    ...
    $ =
      p($, 3) && 0 != q($, 3).length
        ...
        : "";
    d: {
      d = 0 == t(d, 20).length || 2 == e ? t(d, 19) : t(d, 20);
      for (var o, l = d.length, g = 0; g < l; ++g) {
        o = d[g];
        var s = w(o, 3);
        if (
          (0 == s || 0 == a.search(q(o, 3, s - 1))) &&
          ((s = new RegExp(q(o, 1))), N(s, a))
        ) {
          d = o;
          break d;
        }
    ...
    null != d &&
      ...
      (l = v(l, 4)),
      (a =
        2 == e && null != l && 0 < l.length
          ? a.replace(o, d.replace(hd, l))
          : a.replace(o, d)),
      3 == e &&
        ((a = a.replace(
          RegExp("^[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]+"),
  ...
  function Q(d) {
    if (!p(d, 2)) return "";
    var $ = "" + q(d, 2);
    return p(d, 4) && q(d, 4) && 0 < v(d, 8)
      ? Array(v(d, 8) + 1).join("0") + $
      : $;
  }
  function Sa(d, $, e, i) {
    switch ($) {
  ...
  function W(d, $) {
    var e = d.length;
    return !(0 < w($, 9) && -1 == t($, 9).indexOf(e)) && N(v($, 2), d);
  }
  function Ta(d, $) {
    if (null == $) return null;
    var e = v($, 1);
  ...
  function X(d, $, e, i) {
    var a = U(e, i),
      o = 0 == w(a, 9) ? t(q(e, 1), 9) : t(a, 9);
    a = t(a, 10);
    if (2 == i) {
      if (!Pa(U(e, 0))) return X(d, $, e, 1);
      (d = U(e, 1)),
        Pa(d) &&
          ((o = o.concat(0 == w(d, 9) ? t(q(e, 1), 9) : t(d, 9))),
          o.sort(),
          0 == a.length
            ? (a = t(d, 10))
            : ((a = a.concat(t(d, 10))), a.sort()));
    }
    if (-1 == o[0]) return 5;
    $ = $.length;
  ...
  function Wa(d, $) {
    ...
    for (var e, i = d.length, a = 1; 3 >= a && a <= i; ++a)
      if (((e = parseInt(d.substring(0, a), 10)), e in K))
        return $.g(d.substring(a)), e;
    return 0;
  }
  function Xa(d, $, e, i, a, o) {
    ...
    var g = $.toString();
    if (0 == g.length) l = 20;
    else if (nd.test(g)) (g = g.replace(nd, "")), C($), $.g(Na(g)), (l = 1);
    else {
      g = new RegExp(l);
      Oa($);
      l = $.toString();
      if (0 == l.search(g)) {
        ...
        var s = l.substring(g).match(ed);
        s && null != s[1] && 0 < s[1].length && "0" == O(s[1], j)
          ? (l = !1)
          : (C($), $.g(l.substring(g)), (l = !0));
      } else l = !1;
      l = l ? 5 : 20;
    }
    a && r(o, 6, l);
    ...
    if (
      ...
      (s = $.toString()),
      0 == s.lastIndexOf(g, 0) &&
        ((g = new B(s.substring(g.length))),
        (s = q(e, 1)),
        (s = new RegExp(v(s, 2))),
        Ya(g, e, null),
        (g = g.toString()),
        (!N(s, $.toString()) && N(s, g)) || 3 == X(d, $.toString(), e, -1)))
    )
      return i.g(g), a && r(o, 6, 10), r(o, 1, l), l;
    r(o, 1, 0);
    return 0;
  }
  function Ya(d, $, e) {
  ...
  function Za(d, $, e, i) {
    ...
    null == g
      ...
      : 0 === g.length
        ? (l = !1)
        : ((l = ud.exec(g)), (g = ld.exec(g)), (l = null !== l || null !== g));
    if (!l)
      throw Error("The string supplied did not seem to be a phone number");
    null != o
      ? ("+" === o.charAt(0) && a.g(o),
    ...
    o = a.toString();
    l = o.indexOf(";isub=");
    0 < l && (C(a), a.g(o.substring(0, l)));
    if (!Ma(a.toString()))
      throw Error("The string supplied did not seem to be a phone number");
    o = a.toString();
    if (!(P(e) || (null != o && 0 < o.length && nd.test(o))))
      throw Error("Invalid country calling code");
    o = new H();
    i && r(o, 5, $);
    d: {
    ...
    try {
      ...
      if ("Invalid country calling code" != e.message || !nd.test(s)) throw e;
      if (((s = s.replace(nd, "")), (g = Xa(d, s, l, $, i, o)), 0 == g))
        throw e;
    }
    0 != g
      ? ((a = S(g)), a != e && (l = R(d, g, a)))
    ...
    null != l &&
      ...
      (a = new B($.toString())),
      Ya(a, l, e),
      (d = X(d, a.toString(), l, -1)),
      2 != d &&
        4 != d &&
        5 != d &&
        (($ = a), i && 0 < e.toString().length && r(o, 7, e.toString())));
    i = $.toString();
    d = i.length;
    if (2 > d)
      throw Error("The string supplied is too short to be a phone number");
  ...
  function $a($) {
    ...
    (this || d).ba = new B();
    (this || d).u = !0;
    (this || d).ea = (this || d).ca = (this || d).la = !1;
    (this || d).ga = J.g();
    (this || d).$ = 0;
    (this || d).h = new B();
    (this || d).ha = !1;
  ...
  function eb(d) {
    for (var $ = d.j.length, e = 0; e < $; ++e) {
      ...
      if (o) return (d.da = a), (d.ha = Cd.test(q(i, 4))), (d.$ = 0), !0;
    }
    return (d.u = !1);
  }
  function fb(d, $) {
  ...
  function gb(d, $) {
    d.s.g($);
    var e = $;
    ed.test(e) || (1 == d.s.h.length && td.test(e))
      ? ("+" == $ ? ((e = $), d.ba.g($)) : ((e = j[$]), d.ba.g(e), d.g.g(e)),
        ($ = e))
      : ((d.u = !1), (d.la = !0));
    if (!d.u) {
      if (!d.la)
    ...
    switch (d.ba.h.length) {
      ...
      case 2:
        return d.s.toString();
      case 3:
        if (!hb(d)) return (d.o = kb(d)), lb(d);
        d.ea = !0;
      default:
        if (d.ea) return ib(d) && (d.ea = !1), d.h.toString() + d.g.toString();
        if (0 < d.j.length) {
          $ = mb(d, $);
          e = nb(d);
          if (0 < e.length) return e;
          fb(d, d.g.toString());
          return eb(d) ? ob(d) : d.u ? Z(d, $) : d.s.toString();
        }
        return lb(d);
    }
  }
  ...
  function nb(d) {
    for (var $ = d.g.toString(), e = d.j.length, i = 0; i < e; ++i) {
      ...
      if (
        new RegExp("^(?:" + o + ")$").test($) &&
        ((d.ha = Cd.test(q(a, 4))),
        (a = $.replace(new RegExp(o, "g"), q(a, 2))),
        (a = Z(d, a)),
        O(a, dd) == d.ba)
      )
        return a;
  ...
  function lb(d) {
    ...
    if (3 <= $.length) {
      for (
        var e =
            d.ca && 0 == d.o.length && 0 < w(d.l, 20) ? t(d.l, 20) : t(d.l, 19),
          i = e.length,
          a = 0;
        a < i;
        ++a
        ...
        var o = e[a];
        (0 < d.o.length && Qa(v(o, 4)) && !q(o, 6) && !p(o, 5)) ||
          ((0 != d.o.length || d.ca || Qa(v(o, 4)) || q(o, 6)) &&
            pd.test(v(o, 2)) &&
            d.j.push(o));
      }
      fb(d, $);
      $ = nb(d);
      return 0 < $.length ? $ : eb(d) ? ob(d) : d.s.toString();
    }
    return Z(d, $);
  }
  function ob(d) {
    var $ = d.g.toString(),
      e = $.length;
    if (0 < e) {
      for (var i = "", a = 0; a < e; a++) i = mb(d, $.charAt(a));
  ...
  function ib(d) {
    ...
    d.g.g($.toString());
    $ = S(e);
    "001" == $ ? (d.l = T(d.ga, "" + e)) : $ != d.ka && (d.l = ab(d, $));
    d.h.g("" + e).g(" ");
    d.o = "";
    return !0;
  }
  ...
  k("intlTelInputUtils", {});
  k("intlTelInputUtils.formatNumberAsYouType", (d, $) => {
    try {
      const e = d.replace(/[^+0-9]/g, ""),
        i = new $a($);
      let a = "";
      for (let d = 0; d < e.length; d++)
        ($ = i), ($.ja = gb($, e.charAt(d))), (a = $.ja);
      return a;
    } catch ($) {
      return d;
    }
  });
  k("intlTelInputUtils.formatNumber", (d, $, e) => {
    try {
      const a = J.g(),
        o = Y(a, d, $);
      var i = Va(a, o);
      return 0 == i || 4 == i ? Ra(a, o, "undefined" === typeof e ? 0 : e) : d;
    } catch ($) {
      return d;
    }
  });
  k("intlTelInputUtils.getExampleNumber", (d, $, e) => {
    try {
      const g = J.g();
      d: {
        var i = g;
  ...
  k("intlTelInputUtils.getExtension", (d, $) => {
    try {
      return q(Y(J.g(), d, $), 3);
    } catch (d) {
      return "";
  ...
  k("intlTelInputUtils.getNumberType", (d, $) => {
    try {
      const g = J.g();
      var e = Y(g, d, $);
      d = g;
  ...
  k("intlTelInputUtils.getValidationError", (d, $) => {
    try {
      const e = J.g(),
        i = Y(e, d, $);
      return Va(e, i);
  ...
  k("intlTelInputUtils.isValidNumber", (d, $) => {
    try {
      const s = J.g();
      var e = Y(s, d, $);
      d = s;
      ...
      var a = v(e, 1),
        o = R(d, a, i);
      if (null == o || ("001" != i && a != Ua(d, i))) var l = !1;
      else {
        var g = Q(e);
        l = -1 != V(g, o);
      }
  ...
  k("intlTelInputUtils.isPossibleNumber", (d, $) => {
    try {
      const e = J.g(),
        i = Y(e, d, $);
      return 0 === Va(e, i);
