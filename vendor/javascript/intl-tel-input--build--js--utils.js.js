(function () {
  ...
  function m($, e) {
    ...
    var i = d;
    $[0] in i ||
      "undefined" == typeof i.execScript ||
      i.execScript("var " + $[0]);
    for (var a; $.length && (a = $.shift()); )
      $.length || void 0 === e
        ? (i = i[a] && i[a] !== Object.prototype[a] ? i[a] : (i[a] = {}))
        : (i[a] = e);
  }
  function n(d, $) {
    function c() {}
    ...
    d.sa = function (d, e, i) {
      for (
        ...
        a[o - 2] = arguments[o];
      return $.prototype[e].apply(d, a);
    };
  }
  function aa(d) {
    const $ = [];
    let e = 0;
    for (const i in d) $[e++] = d[i];
    return $;
  }
  var $ = class {
      constructor(d) {
        if (e !== e) throw Error("SafeUrl is not meant to be built directly");
        this.g = d;
      }
      toString() {
  ...
  class fa {
    constructor() {
      if (i !== i) throw Error("SafeStyle is not meant to be built directly");
    }
    toString() {
      return "".toString();
    }
  ...
  class ka {
    constructor() {
      var $ = (d.trustedTypes && d.trustedTypes.emptyHTML) || "";
  ...
  function wa(d, $) {
    for (var e = ua(d.m()), i = 0; i < e.length; i++) {
      var a = e[i],
        o = a.g;
      if (q($, o)) {
        d.g && delete d.g[a.g];
        ...
        if (a.l) {
          a = u($, o);
          for (var g = 0; g < a.length; g++) va(d, o, l ? a[g].clone() : a[g]);
        } else
          (a = v($, o)),
            l ? ((l = v(d, o)) ? wa(l, a) : t(d, o, a.clone())) : t(d, o, a);
      }
    }
  }
  p.prototype.clone = function () {
    var d = new this.constructor();
    d != this && ((d.h = {}), d.g && (d.g = {}), wa(d, this));
    return d;
  };
  function q(d, $) {
    return null != d.h[$];
  ...
  function v(d, $) {
    ...
    if (d.l) {
      if (!($ in d.g)) {
        ...
        if (null != e)
          if (a.l) {
            for (var o = [], l = 0; l < e.length; l++) o[l] = i.h(a, e[l]);
            e = o;
          } else e = i.h(a, e);
        return (d.g[$] = e);
      }
  ...
  function x(d, $) {
    return d.j[$].l ? (q(d, $) ? d.h[$].length : 0) : q(d, $) ? 1 : 0;
  }
  function t(d, $, e) {
    d.h[$] = e;
    d.g && (d.g[$] = e);
  ...
  function y(d, $) {
    var e,
      i = [];
    for (e in $) 0 != e && i.push(new la(e, $[e]));
    return new ta(d, i);
  }
  function z() {}
  ...
  z.prototype.h = function (d, $) {
    if (11 == d.h || 10 == d.h)
      return $ instanceof p ? $ : this.g(d.s.prototype.m(), $);
    if (14 == d.h)
      return "string" === typeof $ && _.test($) && ((d = Number($)), 0 < d)
        ? d
        : $;
    if (!d.o) return $;
    d = d.s;
  ...
  function C() {}
  n(C, B);
  C.prototype.h = function (d, $) {
    return 8 == d.h ? !!$ : z.prototype.h.apply(this, arguments);
  };
  C.prototype.g = function (d, $) {
    return C.ma.g.call(this, d, $);
  };
  function D(d, $) {
    ...
    d ||
      (k = d =
        y(I, {
          ...
          6: { name: "country_code_source", i: 14, defaultValue: 0, type: dd },
  ...
  var ed = {
    ...
    id = RegExp("[+＋]+"),
    ad = RegExp("^[+＋]+"),
    od = RegExp("([0-9０-９٠-٩۰-۹])"),
    ud = RegExp("[+＋0-9０-９٠-٩۰-۹]"),
    ld = /[\\\/] *x/,
    gd = RegExp("[^0-9０-９٠-٩۰-۹A-Za-z#]+$"),
    sd = /(?:.*?[A-Za-z]){3}.*/,
    hd = RegExp(
  ...
  var pd = new RegExp("(?:" + Pa() + ")$", "i"),
    ...
    md = /^\(?\$1\)?$/;
  function Ua(d) {
    return !(2 > d.length) && N(fd, d);
  }
  function Va(d) {
    return N(sd, d) ? O(d, rd) : O(d, ed);
  }
  function Wa(d) {
    var $ = Va(d.toString());
    E(d);
  ...
  function Xa(d) {
    return null != d && (1 != x(d, 9) || -1 != u(d, 9)[0]);
  }
  function O(d, $) {
    for (var e, i = new D(), a = d.length, o = 0; o < a; ++o)
      (e = d.charAt(o)), (e = $[e.toUpperCase()]), null != e && i.g(e);
    return i.toString();
  }
  function Ya(d) {
    return 0 == d.length || md.test(d);
  }
  function P(d) {
    return null != d && isNaN(d) && d.toUpperCase() in td;
  }
  K.prototype.format = function (d, $) {
    if (0 == r(d, 2) && q(d, 5)) {
      var e = w(d, 5);
    ...
    e = w(d, 1);
    var i = Q(d);
    if (0 == $) return Za(e, 0, i, "");
    if (!(e in $d)) return i;
    var a = R(this, e, S(e));
    d =
      q(d, 3) && 0 != r(d, 3).length
        ? 3 == $
          ? ";ext=" + r(d, 3)
          : q(a, 13)
            ? r(a, 13) + w(d, 3)
        ...
        : "";
    d: {
      a = 0 == u(a, 20).length || 2 == $ ? u(a, 19) : u(a, 20);
      for (var o, l = a.length, g = 0; g < l; ++g) {
        o = a[g];
        var s = x(o, 3);
        if (
          (0 == s || 0 == i.search(r(o, 3, s - 1))) &&
          ((s = new RegExp(r(o, 1))), N(s, i))
        ) {
          a = o;
          break d;
        }
  ...
  function Q(d) {
    if (!q(d, 2)) return "";
    var $ = "" + r(d, 2);
    return q(d, 4) && r(d, 4) && 0 < w(d, 8)
      ? Array(w(d, 8) + 1).join("0") + $
      : $;
  }
  function Za(d, $, e, i) {
    switch ($) {
  ...
  function V(d, $) {
    var e = d.length;
    return !(0 < x($, 9) && -1 == u($, 9).indexOf(e)) && N(w($, 2), d);
  }
  function ab(d, $) {
    if (null == $) return null;
    var e = w($, 1);
  ...
  function S(d) {
    d = $d[d];
    return null == d ? "ZZ" : d[0];
  }
  function bb(d, $) {
    d = T(d, $);
    if (null == d) throw Error("Invalid region code: " + $);
    return w(d, 10);
  }
  function W(d, $, e, i) {
    var a = U(e, i),
      o = 0 == x(a, 9) ? u(r(e, 1), 9) : u(a, 9);
    a = u(a, 10);
    if (2 == i) {
      if (!Xa(U(e, 0))) return W(d, $, e, 1);
      (d = U(e, 1)),
        Xa(d) &&
          ((o = o.concat(0 == x(d, 9) ? u(r(e, 1), 9) : u(d, 9))),
          o.sort(),
          0 == a.length
            ? (a = u(d, 10))
            : ((a = a.concat(u(d, 10))), a.sort()));
    }
    if (-1 == o[0]) return 5;
    $ = $.length;
    if (-1 < a.indexOf($)) return 4;
    e = o[0];
    return e == $
      ? 0
      : e > $
  ...
  function cb(d, $) {
    d = d.toString();
    if (0 == d.length || "0" == d.charAt(0)) return 0;
    for (var e, i = d.length, a = 1; 3 >= a && a <= i; ++a)
      if (((e = parseInt(d.substring(0, a), 10)), e in $d))
        return $.g(d.substring(a)), e;
    return 0;
  }
  function db(d, $, e, i, a, o) {
    ...
    var g = $.toString();
    if (0 == g.length) l = 20;
    else if (ad.test(g)) (g = g.replace(ad, "")), E($), $.g(Va(g)), (l = 1);
    else {
      g = new RegExp(l);
      Wa($);
      l = $.toString();
      if (0 == l.search(g)) {
        g = l.match(g)[0].length;
        var s = l.substring(g).match(od);
        s && null != s[1] && 0 < s[1].length && "0" == O(s[1], ed)
          ? (l = !1)
          : (E($), $.g(l.substring(g)), (l = !0));
      } else l = !1;
      l = l ? 5 : 20;
    }
    a && t(o, 6, l);
    ...
    if (
      ...
      (s = $.toString()),
      0 == s.lastIndexOf(g, 0) &&
        ((g = new D(s.substring(g.length))),
        (s = r(e, 1)),
        (s = new RegExp(w(s, 2))),
        eb(g, e, null),
        (g = g.toString()),
        (!N(s, $.toString()) && N(s, g)) || 3 == W(d, $.toString(), e, -1)))
    )
      return i.g(g), a && t(o, 6, 10), t(o, 1, l), l;
    t(o, 1, 0);
    return 0;
  }
  function eb(d, $, e) {
    var i = d.toString(),
      a = i.length,
      o = r($, 15);
    if (0 != a && null != o && 0 != o.length) {
      var l = new RegExp("^(?:" + o + ")");
      if ((a = l.exec(i))) {
        o = new RegExp(w(r($, 1), 2));
        var g = N(o, i),
          s = a.length - 1;
        $ = r($, 16);
        null == $ || 0 == $.length || null == a[s] || 0 == a[s].length
          ? (g && !N(o, i.substring(a[0].length))) ||
            (null != e && 0 < s && null != a[s] && e.g(a[1]),
            d.set(i.substring(a[0].length)))
          : ((i = i.replace(l, $)), !g || N(o, i)) &&
            (null != e && 0 < s && e.g(a[1]), d.set(i));
      }
    }
  }
  function Y(d, $, e) {
    if (!P(e) && 0 < $.length && "+" != $.charAt(0))
      throw Error("Invalid country calling code");
    return fb(d, $, e, !0);
  }
  function fb(d, $, e, i) {
    ...
    var a = new D();
    var o = $.indexOf(";phone-context=");
    if (-1 === o) o = null;
    else if (((o += 15), o >= $.length)) o = "";
    else {
      var l = $.indexOf(";", o);
      o = -1 !== l ? $.substring(o, l) : $.substring(o);
    }
    var g = o;
    null == g
      ? (l = !0)
      : 0 === g.length
        ? (l = !1)
        : ((l = hd.exec(g)), (g = cd.exec(g)), (l = null !== l || null !== g));
    if (!l)
      throw Error("The string supplied did not seem to be a phone number");
    null != o
      ? ("+" === o.charAt(0) && a.g(o),
        (o = $.indexOf("tel:")),
        a.g($.substring(0 <= o ? o + 4 : 0, $.indexOf(";phone-context="))))
      : ((o = a.g),
        (l = $ ?? ""),
        (g = l.search(ud)),
        0 <= g
    ...
    o = a.toString();
    l = o.indexOf(";isub=");
    0 < l && (E(a), a.g(o.substring(0, l)));
    if (!Ua(a.toString()))
      throw Error("The string supplied did not seem to be a phone number");
    o = a.toString();
    if (!(P(e) || (null != o && 0 < o.length && ad.test(o))))
      throw Error("Invalid country calling code");
    o = new I();
    i && t(o, 5, $);
    d: {
      $ = a.toString();
      l = $.search(pd);
      if (0 <= l && Ua($.substring(0, l))) {
        g = $.match(pd);
        for (var s = g.length, h = 1; h < s; ++h)
          if (null != g[h] && 0 < g[h].length) {
            E(a);
            a.g($.substring(0, l));
            $ = g[h];
            break d;
    ...
    try {
      ...
      if ("Invalid country calling code" != e.message || !ad.test(s)) throw e;
      if (((s = s.replace(ad, "")), (g = db(d, s, l, $, i, o)), 0 == g))
        throw e;
    }
    0 != g
      ? ((a = S(g)), a != e && (l = R(d, g, a)))
      : (Wa(a),
        ...
        null != e
          ? ((g = w(l, 10)), t(o, 1, g))
          : i && (delete o.h[6], o.g && delete o.g[6]));
    if (2 > $.h.length)
    ...
    null != l &&
      ...
      (a = new D($.toString())),
      eb(a, l, e),
      (d = W(d, a.toString(), l, -1)),
      2 != d &&
        4 != d &&
        5 != d &&
        (($ = a), i && 0 < e.toString().length && t(o, 7, e.toString())));
    i = $.toString();
    d = i.length;
    if (2 > d)
      throw Error("The string supplied is too short to be a phone number");
    ...
    if (1 < i.length && "0" == i.charAt(0)) {
      t(o, 4, !0);
      for (d = 1; d < i.length - 1 && "0" == i.charAt(d); ) d++;
      1 != d && t(o, 8, d);
    }
    t(o, 2, parseInt(i, 10));
    return o;
  ...
  function lb(d) {
    for (var $ = d.j.length, e = 0; e < $; ++e) {
      ...
      var s = o;
      l = w(l, 2);
      var h = "999999999999999".match(g)[0];
      h.length < s.g.h.length
        ? (s = "")
        : ((s = h.replace(new RegExp(g, "g"), l)),
          (s = s.replace(RegExp("9", "g"), " ")));
      0 < s.length ? (o.v.g(s), (o = !0)) : (o = !1);
      if (o) return (d.da = a), (d.ha = Ed.test(r(i, 4))), (d.$ = 0), !0;
    }
    return (d.u = !1);
  }
  function mb(d, $) {
    for (var e = [], i = $.length - 3, a = d.j.length, o = 0; o < a; ++o) {
      var l = d.j[o];
      0 == x(l, 3)
        ? e.push(d.j[o])
        : ((l = r(l, 3, Math.min(i, x(l, 3) - 1))),
          0 == $.search(l) && e.push(d.j[o]));
    }
    d.j = e;
  }
  function nb(d, $) {
    d.s.g($);
    var e = $;
    od.test(e) || (1 == d.s.h.length && id.test(e))
      ? ("+" == $ ? ((e = $), d.ba.g($)) : ((e = ed[$]), d.ba.g(e), d.g.g(e)),
        ($ = e))
      : ((d.u = !1), (d.la = !0));
    if (!d.u) {
      if (!d.la)
    ...
    switch (d.ba.h.length) {
      ...
      case 2:
        return d.s.toString();
      case 3:
        if (!ob(d)) return (d.o = rb(d)), sb(d);
        d.ea = !0;
      default:
        if (d.ea) return pb(d) && (d.ea = !1), d.h.toString() + d.g.toString();
        if (0 < d.j.length) {
          $ = tb(d, $);
          e = ub(d);
          if (0 < e.length) return e;
          mb(d, d.g.toString());
          return lb(d) ? vb(d) : d.u ? Z(d, $) : d.s.toString();
        }
        return sb(d);
    }
  }
  ...
  function ub(d) {
    for (var $ = d.g.toString(), e = d.j.length, i = 0; i < e; ++i) {
      var a = d.j[i],
        o = w(a, 1);
      if (
        new RegExp("^(?:" + o + ")$").test($) &&
        ((d.ha = Ed.test(r(a, 4))),
        (a = $.replace(new RegExp(o, "g"), r(a, 2))),
        (a = Z(d, a)),
        O(a, nd) == d.ba)
      )
        return a;
  ...
  function Z(d, $) {
    var e = d.h.h.length;
    return d.ha && 0 < e && " " != d.h.toString().charAt(e - 1)
      ? d.h + " " + $
      : d.h + $;
  }
  function sb(d) {
    ...
    if (3 <= $.length) {
      for (
        var e =
            d.ca && 0 == d.o.length && 0 < x(d.l, 20) ? u(d.l, 20) : u(d.l, 19),
          i = e.length,
          a = 0;
        a < i;
        ++a
        ...
        var o = e[a];
        (0 < d.o.length && Ya(w(o, 4)) && !r(o, 6) && !q(o, 5)) ||
          ((0 != d.o.length || d.ca || Ya(w(o, 4)) || r(o, 6)) &&
            bd.test(w(o, 2)) &&
            d.j.push(o));
      }
      mb(d, $);
      $ = ub(d);
      return 0 < $.length ? $ : lb(d) ? vb(d) : d.s.toString();
    }
    return Z(d, $);
  }
  function vb(d) {
    var $ = d.g.toString(),
      e = $.length;
    if (0 < e) {
      for (var i = "", a = 0; a < e; a++) i = tb(d, $.charAt(a));
      return d.u ? Z(d, i) : d.s.toString();
    }
    return d.h.toString();
  }
  function rb(d) {
    var $ = d.g.toString(),
      e = 0;
    if (1 != r(d.l, 10)) var i = !1;
    else
      (i = d.g.toString()),
        (i = "1" == i.charAt(0) && "0" != i.charAt(1) && "1" != i.charAt(1));
    i
      ? ((e = 1), d.h.g("1").g(" "), (d.ca = !0))
      : q(d.l, 15) &&
        ((i = new RegExp("^(?:" + r(d.l, 15) + ")")),
        (i = $.match(i)),
        null != i &&
          null != i[0] &&
          0 < i[0].length &&
          ((d.ca = !0), (e = i[0].length), d.h.g($.substring(0, e))));
    E(d.g);
    d.g.g($.substring(e));
    return $.substring(0, e);
  }
  function ob(d) {
    var $ = d.ba.toString(),
      e = new RegExp("^(?:\\+|" + r(d.l, 11) + ")");
    e = $.match(e);
    return (
      null != e &&
      null != e[0] &&
  ...
  function pb(d) {
    ...
    d.g.g($.toString());
    $ = S(e);
    "001" == $ ? (d.l = T(d.ga, "" + e)) : $ != d.ka && (d.l = hb(d, $));
    d.h.g("" + e).g(" ");
    d.o = "";
    return !0;
  }
  ...
  m("intlTelInputUtilsTemp.formatNumberAsYouType", (d, $) => {
    try {
      const e = d.replace(/[^+0-9]/g, ""),
        i = new gb($);
      $ = "";
      for (let d = 0; d < e.length; d++)
        (i.ja = nb(i, e.charAt(d))), ($ = i.ja);
      return $;
    } catch ($) {
      return d;
    }
  });
  m("intlTelInputUtilsTemp.formatNumber", (d, $, e) => {
    try {
      const a = K.g(),
        o = Y(a, d, $);
      var i = X(a, o, -1);
      return 0 == i || 4 == i
        ? a.format(o, "undefined" === typeof e ? 0 : e)
        : d;
    } catch ($) {
      return d;
    }
  });
  m("intlTelInputUtilsTemp.getExampleNumber", (d, $, e, i) => {
    try {
      const s = K.g();
      d: {
        var a = s;
      ...
      return s.format(g, i ? 0 : $ ? 2 : 1);
    } catch (d) {
      return "";
    }
  });
  m("intlTelInputUtilsTemp.getExtension", (d, $) => {
    try {
      return r(Y(K.g(), d, $), 3);
    } catch (d) {
      return "";
  ...
  m("intlTelInputUtilsTemp.getNumberType", (d, $) => {
    try {
      const l = K.g(),
        g = Y(l, d, $);
      var e = ab(l, g),
  ...
  m("intlTelInputUtilsTemp.getValidationError", (d, $) => {
    try {
      const e = K.g(),
        i = Y(e, d, $);
      return X(e, i, -1);
    } catch ($) {
      return "Invalid country calling code" === $.message
        ? 1
        : 3 >= d.length ||
            "Phone number too short after IDD" === $.message ||
            "The string supplied is too short to be a phone number" ===
              $.message
          ? 2
          : "The string supplied is too long to be a phone number" === $.message
            ? 3
            : -99;
    }
  });
  m("intlTelInputUtilsTemp.isValidNumber", (d, $) => {
    try {
      const s = K.g();
      var e = Y(s, d, $),
        i = ab(s, e);
      ...
      var a = w(e, 1),
        o = R(d, a, i);
      if (null == o || ("001" != i && a != bb(d, i))) var l = !1;
      else {
        var g = Q(e);
        l = -1 != $a(g, o);
      }
  ...
  m("intlTelInputUtilsTemp.isPossibleNumber", (d, $, e) => {
    try {
      const i = K.g(),
        a = Y(i, d, $);
      return e ? 0 === X(i, a, Td[e]) : 0 === X(i, a, -1);
    } catch (d) {
      return !1;
    }
  });
  m("intlTelInputUtilsTemp.getCoreNumber", (d, $) => {
    try {
      return r(Y(K.g(), d, $), 2).toString();
    } catch (d) {
      return "";
    }
  });
  ...
  m("intlTelInputUtilsTemp.numberType", Td);
...
const d = window.intlTelInputUtilsTemp;
